...
public class SearchServiceTest {
	...
	public void testSearchReposity() throws SearchException {
		...
		List<RepositoryResponse> reporesp = searchServiceImpl.searchRepository(q, sort, order);
		Assert.assertNotNull(reporesp);
	...
	public void testSearchUser() throws SearchException {
		...
		List<UserResponse> res = searchServiceImpl.searchUser(q, sort, order);
